...
<body>
    <div class="container">
        <div class="create-container bg-light text-dark container mt-5">
            <h3 class="title text-center">Register Akun</h3>
            <?php if (session()->get('success')) : ?>
                <div class="alert alert-success" role="alert">
                    <?= session()->get('success') ?>
                </div>
            <?php endif; ?>
            <?php if(session()->get('failRegis')) : ?>
                <div class="alert alert-danger" role="alert">
                    <?= session()->get('failRegis') ?>
                </div>
            <?php endif; ?>
            ...
            <form action="/register" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="nama" class="form-control" id="nama" name="nama" autofocus required>
                </div>
                <div class="mb-3">
                ...
                <p>Sudah punya akun? <span><a href="/">Login disini</a></span></p>
